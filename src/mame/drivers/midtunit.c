...
ROM_START( mk2p )
	ROM_REGION16_LE( 0xc00000, "dcs", ROMREGION_ERASEFF )	/* sound data */
	ROM_LOAD16_BYTE( "l1_mortal_kombat_ii_sound_rom_u2.u2", 0x000000, 0x80000, CRC(65d11dd7) SHA1(bb94cca5a35f8f285d32314f8762c3c52ec48f5b) )
	ROM_RELOAD(	               0x100000, 0x80000 )
	...
	ROM_REGION16_LE( 0x100000, "user1", 0 )	/* 34010 code */
	ROM_LOAD16_BYTE( "l3.1_mortal_kombat_ii_game_rom_uj12.uj12", 0x00000, 0x80000, CRC(05ff15a9) SHA1(23e9c47644c756d7568b6e5122801b19cf594e9b) )
	ROM_LOAD16_BYTE( "l3.1_mortal_kombat_ii_game_rom_ug12.ug12", 0x00001, 0x80000, CRC(b6d8ff5c) SHA1(ad974cc0dcdf35c7175f7cb8c620b58b82843523) )
	...
	ROM_LOAD( "l1_mortal_kombat_ii_game_rom_ug16.ug16", 0x100000, 0x100000, CRC(b2af2798) SHA1(3d679fb59753b72f961fe60a65e4e03a76b64266) )
	...
	ROM_LOAD( "l1_mortal_kombat_ii_game_rom_uj16.uj16", 0x400000, 0x100000, CRC(d70dd149) SHA1(1add61f22a68c0bd8dba3fa0da18f5ecc7f51c6f) )
	...
	ROM_LOAD( "l1_mortal_kombat_ii_game_rom_ug20.ug20", 0x700000, 0x100000, CRC(d05e970a) SHA1(0f07d72c0ae9ed77c79b4a39abbc047df68a6b1d) )
	...
	ROM_LOAD( "l1_mortal_kombat_ii_game_rom_uj20.uj20", 0xa00000, 0x100000, CRC(0f9c9a12) SHA1(6c593ab037f9e203e50a13bef1cdbba765a45845) )
...
GAME( 2018, mk2p,     mk2,     tunit_dcs,   mk2,      mk2,      ROT0, "Team Plus","Mortal Kombat II + (beta 2)", GAME_SUPPORTS_SAVE )
